...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? const MoodsWidget() : const LoginWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: 'Relaxation',
          path: '/relaxation',
          builder: (context, params) => const RelaxationWidget(),
        ),
        FFRoute(
          name: 'Question1',
          path: '/question1',
        ...
        FFRoute(
          name: 'Moods',
          path: '/moods',
          builder: (context, params) => const MoodsWidget(),
        ),
        FFRoute(
          name: 'Tunes',
          path: '/tunes',
          builder: (context, params) => const TunesWidget(),
        ),
        FFRoute(
          name: 'breathing',
          path: '/breathing',
          builder: (context, params) => const BreathingWidget(),
        ),
        FFRoute(
          name: 'meditation',
          path: '/meditation',
        ...
        FFRoute(
          name: 'moodhome',
          path: '/moodhome',
          builder: (context, params) => const MoodhomeWidget(),
        ),
        FFRoute(
          name: 'Workoutpage',
          path: '/workoutpage',
        ...
        FFRoute(
          name: 'WaterPage',
          path: '/waterPage',
          builder: (context, params) => const WaterPageWidget(),
        ),
        FFRoute(
          name: 'Hydrated',
          path: '/hydrated',
          builder: (context, params) => const HydratedWidget(),
        ),
        FFRoute(
          name: 'tunesredirect',
          path: '/tunesredirect',
          builder: (context, params) => const TunesredirectWidget(),
        )
